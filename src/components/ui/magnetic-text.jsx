...
export function MagneticText({ text = "CREATIVE", hoverText = "EXPLORE", className }) {
    ...
    return (
        ...
        >
            ...
            <span className="text-huge font-bold tracking-tighter text-foreground whitespace-nowrap">{text}</span>

            <div
                ref={circleRef}
                className="absolute top-0 left-0 pointer-events-none rounded-full bg-accent overflow-hidden"
                style={{
            ...
            >
                ...
                >
                    <span className="text-huge font-bold tracking-tighter text-background whitespace-nowrap">
                        {hoverText}
                    </span>
                </div>
            </div>
